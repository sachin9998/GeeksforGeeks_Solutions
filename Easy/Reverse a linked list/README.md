<h2><a href="https://practice.geeksforgeeks.org/problems/reverse-a-linked-list/1?page=1&status[]=unsolved&category[]=Linked%20List&sortBy=submissions">Reverse a linked list</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a linked list of <strong>N </strong>nodes. The task is to reverse this list.</span></p>
